...
// File: localhost/contracts/libs/ITokenReferral.sol
...
// File: localhost/contracts/Token.sol

pragma solidity 0.6.12;


// Token with Governance.
contract Token is BEP20("Werewolf TEST Token", "WEREWOLF") {
    // Burn address
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TOKEN::transfer: Burn value invalid");
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    // Initial emission rate: 0.5 TOKEN per block.
    ...
    // Reduce emission every 19,200 blocks ~ 16 hours.
    ...
    function updateEmissionRate() public {
        ...
        require(tokenPerBlock > MINIMUM_EMISSION_RATE, "updateEmissionRate: Emission rate has reached the minimum threshold");
